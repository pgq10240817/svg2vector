...
class SvgLeafNode extends SvgNode {
	...
	// Key is the attributes for vector drawable, and the value is the converted
	// from SVG.
	...
	private String getAttributeValues(HashMap<String, String> presentationMap) {
	...
	public void fillPresentationAttributes(String name, String value) {
		...
		if (value.startsWith("url(")) {
			getTree().logErrorLine("Unsupported URL value: " + value, getDocumentNode(), SvgTree.SvgLogLevel.ERROR);
			return;
		}
